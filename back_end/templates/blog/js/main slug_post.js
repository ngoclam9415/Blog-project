  ...
  var post_comment_url = window.location.origin + "/uploadcomment"
...
function insert_comment(url){
  var url_ele_list = window.location.href.split("/");
  var slug = url_ele_list[url_ele_list.length - 1];
  var data = {
    slug : slug,
